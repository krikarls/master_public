...
def PressureUpdatePhase3(i,V_ED):
	...
	while err > 0.001:
		...
		print ' \n Now doing iteration number ', iterations, ' for pressure update: ejection phase. \n'
...
P =  J*(passive_cauchy_stress+active_cauchy_stress)*inv(F).T
...
while cycle <= cycles:
	...
	Save('dynamic_elastic.h5', 'timestep'+str(ts_counter), uvp)
